...
function Login() {
  return (
    ...
    <div className="main-wrapper " >
      ...
      >
        <div className="auth-box p-4 bg-white ">
          <div id="loginform">
            <div className="logo">
              ...
              <div className="col-12">
                ...
                >
                  <div className="form-group mb-3">
                    <div className="">
                      <input
                        className="form-control  border-left-0 border-right-0  border-hrefp-0"
                        type="text"
                        required=""
                  ...
                  <div className="form-group">
                    <div className="d-flex ">
                      <div className="checkbox checkbox-info pt-0  mr-auhref ">
                        <input
                          id="checkbox-signup"
                          type="checkbox"
                      ...
                      <div className="ms-auhref">
                        <a
                          ...
                          id="href-recover"
                          className="a font-weight-medium"
